# -*- coding: utf-8 -*-
"""
disclaimer_window__ui__.py
------------------------------
Haftungsausschluss-Dialog (Hilfe -> Haftungsausschluss). Text kommt
vollständig aus den Sprachpaketen (disclaimer.title / disclaimer.body),
ist also automatisch mehrsprachig.
"""
...
class DisclaimerWindow(QDialog):
    ...
    def retranslate_ui(self) -> None:
        tr = self.bot.tr
        self.setWindowTitle(tr("disclaimer.title"))
        self.body_label.setText(tr("disclaimer.body"))
